...
def load_graph(group_id):
    ...
    url = "https://graph.facebook.com/v2.4/%s/feed?fields=%s&since=%s&limit=%s&access_token=%s" % (group_id, config.fields,since_handler(sys.argv[2]), paging_limit, config.access_token)
